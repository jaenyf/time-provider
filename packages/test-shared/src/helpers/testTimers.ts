...
import { asap, type IScheduledHandle } from "@time-provider/core";
import type { IDeterministicTimers } from "@time-provider/core/deterministic";

export function testTimers(createSUT: () => IDeterministicTimers, isTimeFrozen: boolean = false) {
  describe("once", () => {
